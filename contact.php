...
<!--	Title
	=========================================================-->
<title>Estate and Asset Management PHP</title>
</head>
<body>
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">Arise Software Solutions, Malakpet</span> <br>
										<span class="text-white">Arise Software Solutions, Malakpet</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+91 90000 90000</span>
										<span class="text-white">+91 90001 90001 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-white">helpline@AriseRealestateSolutions.com</span>
										<span class="text-white">helpline@AriseRealestateSolutions.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
